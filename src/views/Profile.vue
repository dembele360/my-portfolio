...
const profile = reactive({
    fullName: 'Musa Mustapha',
    position: 'Full-stack Sotware Developer',
});
</script>
<template>
    <div class="container">
        <div class="profile">
            <div class="profile__image">
                <v-avatar :size="smAndDown ? 200 : 300">
                    <v-img src="profile-image3.jfif" lazy-src="profile-image3.jfif" alt="Profile avatar" title="Profile avatar"></v-img>
                </v-avatar>
            </div>
